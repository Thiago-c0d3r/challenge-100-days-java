...
o nome é linear pq vc segue uma ordem linear, um por um, até achar o valor desejado
...
a definição simples é: "Quanto o tempo gasto cresce, conforme os dados crescem?" para busca linear a complexidade é: O(n) => quanto mais dados, mais tempo gasto n = quantidade de elementos ou seja, o tempo cresce na mesma proporção dos dados EX: existe um sistema de pedidos, os pedidos estão guardados em lista (ArrayList) são mais de 100 pedidos, veja como funciona a complexidade:
...
equals= compara conteúdo; "==" = compara conteúdo;
